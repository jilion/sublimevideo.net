...
TailorMadePlayerRequestHighriseImporter = Struct.new(:tailor_made_player_request) do
  ...
  def create_case_in_highrise
    ...
    @highrise_kase = highrise_save(Highrise::Kase.new(
  ...
  def attach_note_to_highrise_kase
    ...
    #   attributes[:attachments] = Highrise::Attachment.new(
    #     url: tailor_made_player_request.document.url,
  ...
  def highrise_company
    @highrise_company ||= begin
      ...
      highrise_save(Highrise::Company.new(
