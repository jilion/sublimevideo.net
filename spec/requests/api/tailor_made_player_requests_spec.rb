...
describe Api::TailorMadePlayerRequestsController do
  ...
  context 'unauthenticated' do
    describe "index" do
      it "returns 401" do
        get '/api/tailor-made-players-requests'
    ...
    describe "show" do
      it "returns 401" do
        get '/api/tailor-made-players-requests/1'
        response.status.should eq 401
      end
    end
    ...
    describe "destroy" do
      it "returns 401" do
        delete '/api/tailor-made-players-requests/1'
        response.status.should eq 401
      end
    end
  end
  ...
  context 'authenticated' do
    ...
    before { http_api_login }

    describe "index" do
      it "returns 200" do
        get '/api/tailor-made-players-requests.json', {}, @env
    ...
    describe "show" do
      ...
      it "returns 200" do
        get "/api/tailor-made-players-requests/#{tailor_made_player_request.id}.json", {}, @env
        response.status.should eq 200
      end
    ...
    describe "destroy" do
      ...
      it "returns 204" do
        delete "/api/tailor-made-players-requests/#{tailor_made_player_request.id}.json", {}, @env
